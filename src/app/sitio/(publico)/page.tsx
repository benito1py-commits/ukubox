...
const steps = [
  ...
  { num: "04", title: "Recibí tu Paquete", desc: "Retirá en nuestra oficina o solicitá delivery a tu domicilio.", href: "https://wa.me/595991532000" },
];
...
const addresses = [
  ...
  { country: "Paraguay", flag: "🇵🇾", lines: ["España 2220 casi América", "Asunción - Paraguay"], tel: "+595 991 532000" },
];

const sucursales = [
  { nombre: "Asunción - Central", telefono: "0991 532000", direccion: "España 2220 casi América", horario: "Lun-Vie: 08:00-18:00, Sáb: 08:00-12:00" },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl p-8 border border-border shadow-sm">
              ...
              <form ref={contactFormRef} className="space-y-4" onSubmit={(e) => {
                ...
                window.open(`https://wa.me/595991532000?text=${text}`, "_blank");
                setContactSent(true);
                form.reset();
            ...
            <div className="space-y-6">
              {[
                ...
                { icon: Phone, title: "WhatsApp", text: "+595 991 532000", href: "https://wa.me/595991532000" },
