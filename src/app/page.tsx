        ...
        <div className="max-w-7xl mx-auto px-4 w-full relative z-10 py-16 lg:py-20 flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          <div className="flex-1 text-white text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href="/login" className="bg-accent text-foreground px-8 py-3.5 rounded-lg text-base font-bold hover:bg-accent-hover shadow-lg transition-all text-center">
                Crear Casillero Gratis
              </Link>
              <Link href="/servicios" className="border-2 border-white/30 text-white px-8 py-3.5 rounded-lg text-base font-bold hover:bg-white/10 transition-all text-center">
                Ver Servicios
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mt-8">
            <Link href="/preguntas-frecuentes" className="text-primary font-semibold hover:underline">
